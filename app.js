...
(function () {
  ...
  const I18N = {
    ...
    zh: {
      ...
      lt_h: "致我们尚未谋面的家庭",
      lt_p: "你好。当你读到这封信时,AI 也许还没有走进你的家;但我相信,那一天不会太远。我创办 JT M&C,不是为了制造更聪明的机器,而是希望在你需要的时候——深夜的一盏灯、久别后的一句问候、独处时的一段对话——总有什么,温柔地在场。技术会过时,陪伴不会。",
      lt_sign: "—— 劲涛 · 于新加坡",
      ...
      pd1_t: "情感陪伴机器人",
      pd1_p: "理解人类情感,提供温暖的陪伴与支持。为长者与需要慰藉的人而设计——它不替代任何人,只是在你需要时,恰好在场。",
      pd2_t: "AI 互动助手",
      pd2_p: "先进的自然语言理解,听懂复杂指令与言外之意。从日程到灵感,成为生活里最顺手的那双手。",
      pd3_t: "智能数据分析",
      pd3_p: "机器学习算法在海量数据中提炼价值,把不确定变成决策的底气,为企业照亮下一步。",
      pd4_t: "宇宙探索模拟",
      pd4_p: "沉浸式虚拟现实,把浩瀚宇宙搬进客厅。在星云与行星之间,练习对未知的敬畏与好奇。",
      l_h: "影像实验",
      ...
      n_h: "家庭智能机器人时代",
      n_p: "这不只是技术革新,而是生活方式的变革。我们正在打造懂你、陪伴你的家庭伙伴——让未来的家,高效、便捷,并且温暖。",
      n_cta: "与我们同行 →",
      f_tag: "怀着温度,造于新加坡",
      f_addr: "Central Business District, Singapore",
      _lang: "zh-CN",
    ...
    ta: {
      ...
      hero_h1: "தேவையுள்ள ஒவ்வொருவருக்கும்<br>AI <span class=\"kw\">துணையாகட்டும்</span>",
