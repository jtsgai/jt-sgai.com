...
(function () {
  ...
  const I18N = {
    en: {
      ...
      ab_p: "Jerry (Jingtao), founder of JT M&C. Deeply focused on AIGC generation pipelines and multilingual content production, while also helping build <a href=\"https://www.redfunplanet.com\" target=\"_blank\" rel=\"noopener\">Red Fun Planet</a>, a children's financial-literacy brand. Every frame on this site comes from our own pipeline.",
    ...
    zh: {
      ...
      ab_h: "这封信的署名人",
      ab_p: "劲涛 Jerry,JT M&C 创始人。深耕 AIGC 生成管线与多语言内容制作,同时参与儿童财商教育品牌 <a href=\"https://www.redfunplanet.com\" target=\"_blank\" rel=\"noopener\">Red Fun Planet</a> 的建设。这个网站上的每一帧影像,都出自我们自己的管线。",
    ...
    ms: {
      ...
      ab_p: "Jerry (Jingtao), pengasas JT M&C. Menumpukan usaha mendalam pada saluran penjanaan AIGC dan pengeluaran kandungan pelbagai bahasa, sambil turut membina <a href=\"https://www.redfunplanet.com\" target=\"_blank\" rel=\"noopener\">Red Fun Planet</a>, jenama literasi kewangan kanak-kanak. Setiap bingkai di laman web ini terhasil daripada saluran paip kami sendiri.",
